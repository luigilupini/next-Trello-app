...
interface BoardState {
  ...
  addTodo: string;
  setAddTodo: (input: string) => void;

  chooseTaskType: TypedColumn;
  setChooseTaskType: (columnId: TypedColumn) => void;
}
...
const useBoardStore = create<BoardState>((set, get) => ({
  ...
  setAddTodo: (input) => set({ addTodo: input }),
  setChooseTaskType: (columnId) => set({ chooseTaskType: columnId }),
}));
